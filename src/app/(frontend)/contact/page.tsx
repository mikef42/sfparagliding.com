    ...
    <div className="py-12 lg:py-16">
      <div className="container-narrow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          {/* Contact Info */}
          <div>
            <h2 className="font-heading text-xl tracking-wide mb-4">Get in Touch</h2>
            <p className="text-gray-600 mb-6">
              Have questions about tandem flights, lessons, or gift certificates?
              We&apos;d love to hear from you!
            </p>
            <div className="space-y-4 text-sm text-gray-700">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-brand-amber flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
                <div>
                  <p className="font-medium">Email</p>
                  <a href="mailto:info@sfparagliding.com" className="text-brand-amber hover:text-brand-amber-hover transition-colors">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+14155551234" className="text-brand-amber hover:text-brand-amber-hover transition-colors">
                    (415) 555-1234
                  </a>
                </div>
              </div>
