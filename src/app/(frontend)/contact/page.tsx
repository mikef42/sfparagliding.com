...
export default async function ContactPage() {
  ...
  const email = contact.email || 'info@sfparagliding.com'
  const phone = contact.phone || '(415) 555-1234'
  const addressLine1 = contact.addressLine1 || 'Pacifica, California'
  const addressLine2 = contact.addressLine2 || 'San Francisco Bay Area'
